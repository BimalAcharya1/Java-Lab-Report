...
public class studentForm extends JFrame {
    public studentForm() {
        ...
        JTextField name = new JTextField(); name.setBounds(120, 20, 200, 30);
          add(new JLabel("Name:")).setBounds(20, 20, 100, 30); add(name);
        JTextField address = new JTextField(); address.setBounds(120, 60, 200, 30); 
          add(new JLabel("Address:")).setBounds(20, 60, 100, 30); add(address);
